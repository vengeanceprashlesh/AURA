  ...
  return (
    <div className="min-h-screen bg-beige-50">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-lg text-charcoal-700">
              Effortless style for every day - comfortable dresses for any casual occasion
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Casual Dresses Products */}
        <ProductGrid 
          category="casual-dresses" 
          title="Casual Dresses"
          emptyMessage="No casual dresses available. Add some casual dresses in the admin panel!"
          className=""
        />
      </div>
    </div>
