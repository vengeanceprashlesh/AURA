  ...
  const categories = [
    {
      ...
      items: ['Chanel', 'Gucci', 'Prada', 'Louis Vuitton', 'Dior']
    },
    {
      name: 'Contemporary',
      href: '/categories/designers/contemporary',
      items: ['Zimmermann', 'Ganni', 'Staud', 'Reformation']
    },
    {
      name: 'Emerging Designers',
      href: '/categories/designers/emerging',
      items: ['New Talent', 'Indie Brands', 'Sustainable Designers']
    }
  ];
    ...
    <div className="min-h-screen bg-beige-50">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-xl text-charcoal-700 max-w-2xl mx-auto">
              Discover the world's most coveted fashion houses and emerging talents
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <nav className="flex items-center space-x-2 text-sm text-charcoal-600 mb-8">
          ...
          <span className="text-charcoal-900 font-medium">Designers</span>
        </nav>
        ...
        <section className="mt-16 text-center bg-dusty-rose-50 rounded-lg p-12">
          ...
          <p className="text-charcoal-700 mb-8 max-w-2xl mx-auto">
            From heritage luxury houses to innovative emerging talents, explore the world's most sought-after designers.
          </p>
          <Link
            href="/categories/designers/all"
