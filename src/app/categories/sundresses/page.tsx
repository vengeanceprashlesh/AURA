...
// Mock product data for Sundresses Collection
const products = [
  {
    id: 1,
...
export default function SundressesPage() {
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm sm:text-base">
                  Perfect sundresses for sunny days
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="relative h-64 sm:h-80 bg-gradient-to-r from-yellow-400 to-orange-400">
        <div className="absolute inset-0 bg-black/30"></div>
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')] bg-cover bg-center opacity-40"></div>
        <div className="relative h-full flex items-center justify-center text-center text-white px-4">
          <div>
            ...
            <p className="text-lg sm:text-xl mb-6 max-w-2xl">
              Embrace the sunshine with our collection of beautiful, breezy sundresses
            </p>
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <span className="bg-white/20 px-3 py-1 rounded-full">Breezy</span>
              <span className="bg-white/20 px-3 py-1 rounded-full">Comfortable</span>
              <span className="bg-white/20 px-3 py-1 rounded-full">Sun-Ready</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="flex justify-between items-center mb-8">
          <h3 className="text-lg sm:text-xl font-semibold text-gray-900">
            {products.length} Beautiful Sundresses
          </h3>
