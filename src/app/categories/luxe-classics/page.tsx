...
// Mock product data for Luxe Classics
const products = [
  {
    id: 1,
...
export default function LuxeClassicsPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <div className="relative h-64 sm:h-80 bg-gradient-to-r from-gray-900 to-gray-700">
        <div className="absolute inset-0 bg-black/30"></div>
        <div className="relative h-full flex items-center justify-center text-center text-white px-4">
          <div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
              Luxe Classics Collection
            </h2>
            <p className="text-lg sm:text-xl mb-6 max-w-2xl">
              Discover timeless elegance with our curated selection of premium pieces
            </p>
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <span className="bg-white/20 px-3 py-1 rounded-full">Premium Quality</span>
              <span className="bg-white/20 px-3 py-1 rounded-full">Sustainable Materials</span>
              <span className="bg-white/20 px-3 py-1 rounded-full">Expert Craftsmanship</span>
            </div>
          </div>
        </div>
      </div>
