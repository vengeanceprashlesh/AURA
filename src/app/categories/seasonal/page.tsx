...
// Mock product data for Seasonal Collection
const products = [
  {
    id: 1,
    name: "Autumn Layering Cardigan",
    price: 89.99,
  ...
  {
    id: 6,
    name: "Seasonal Accessory Bundle",
    price: 69.99,
    originalPrice: 99.99,
...
export default function SeasonalPage() {
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm sm:text-base">
                  It's the season for fresh new looks
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="relative h-64 sm:h-80 bg-gradient-to-r from-rose-600 to-pink-600">
        ...
        <div className="relative h-full flex items-center justify-center text-center text-white px-4">
          <div>
            ...
            <p className="text-lg sm:text-xl mb-6 max-w-2xl">
              Embrace the changing seasons with our curated collection of must-have pieces
            </p>
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <span className="bg-white/20 px-3 py-1 rounded-full">Trending Now</span>
              <span className="bg-white/20 px-3 py-1 rounded-full">Limited Edition</span>
              <span className="bg-white/20 px-3 py-1 rounded-full">Must-Have</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="flex justify-between items-center mb-8">
          <h3 className="text-lg sm:text-xl font-semibold text-gray-900">
            {products.length} Seasonal Products
          </h3>
