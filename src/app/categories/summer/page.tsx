...
// Mock product data for Summer Collection
const products = [
  {
    id: 1,
    name: "Amalfi Coast Sundress",
    price: 129.99,
  ...
  {
    id: 2,
    name: "Mediterranean Vacation Set",
    price: 189.99,
    originalPrice: null,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="flex justify-between items-center mb-8">
          <h3 className="text-lg sm:text-xl font-semibold text-gray-900">
            {products.length} Summer Products
          </h3>
